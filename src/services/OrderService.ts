...
class OrderService {
    ...
    createOrder = async(idOrder:string,idUser:string) => {
    ...
    getOrder = async(idUser:string,page:number,size:number) => {
    ...
    updateStatusOrder = async(idOrder:string,idUser:string) => {
